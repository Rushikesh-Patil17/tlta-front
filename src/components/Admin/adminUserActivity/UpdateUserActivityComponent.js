...
class UpdateUserActivityComponent extends Component {
    constructor(props) {
        ...
        this.changeLearningActivityIdHandler = this.changeLearningActivityIdHandler.bind(
            this
        );
        this.changeStatusHandler = this.changeStatusHandler.bind(this);
        this.changeCertificateHandler = this.changeCertificateHandler.bind(
            this
        );
    ...
    updateUserActivity = (e) => {
        ...
        let userActivity = {
            ...
            learningActivityId: this.state.learningActivityId,
            status: this.state.status,
            certificate: this.state.certificate,
        };
        console.log(JSON.stringify(userActivity));
        ActivityService.updateUserActivity(userActivity).then((res) => {
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <button
                                        ...
                                        onClick={this.updateUserActivity}
                                    >
                                        Update
                                    </button>
                                    <button
